...
namespace Jesse
{
    ...
    InputAndResponses UserInputAndResponses[] = {
        ...
        {"Can animals believe in the same morals as people?", "Well reguarding their young, they are the same as us."},
        ...
        {"Can wild animals believe in the same morals as people?", "It depends on the enviroment."},
        ...
        {"Can wild animals be taught morals?", "If taught in a proper enviroment."},
        ...
        {"Do you think animals know what moras are?", "I don't think so."},
        ...
        {"Why do you think animals have constructed their own morals?", "Any group of the same speices live by said code."},
        {"Why do you see the need to think animals have morals?", "I want to believe that other living creatures have this ability."},
        {"Why do people believe animalls have morals?", "It's really a gray area."},
        ...
        {"Why are morals seen as a death wish in the animal kindgom?", "I don't like being so negative."},
        ...
        {"Tell me can animals believe in the same morals as people?", "No, because they live in a totally different enviroment."},
        ...
        {"Tell me can wild animals hold the same level of morals like people?", "They have their own built around their enviroment."},
        {"Tell me can wild animals lose morals?", "If pushed far enough."},
        {"Tell me can wild animals gain morals?", "Only if it agree's with their natural instincts."},
        ...
        {"Tell me can tame animals gain morals?", "No, that's a rediclous question."},
        ...
        {"Tell me can an animall be trained into adopting morals?", "Possibly."},
        ...
        {"Tell me can morals corrupt the minds of animals?", "If they are in a life or death scenerio."},
        ...
        {"Tell me do you think animals know what morals are?", "Over time and with constent human interaction."},
        ...
        {"Tell me why do morals always seem to get people hurt?", "Usually in scenerios when someone is willing to cross the line."},
        ...
        {"Tell me why are morals seen as a death wish in the animal kindgom?", "It removes the need to survive in difficult situtions."},
        ...
        {"What does one have to do in achieving a good life?", "Scarifice."},
        ...
        {"How does one achieve a good life?", "Through hardwork and sacrifice."},
        ...
        {"Do you beieve it's possible in achieving a better life?", "Anything is possible."},
        ...
        {"Do see a better life happening?", "It will be alot of work but it is possible."},
        ...
        {"Does wealth make for a better life?", "Only when it comes to material pocession."},
        ...
        {"Can you see helping others in aquiring a better life?", "Anything can happen."},
        {"Can a better life come to those who wait?", "No, a better life is aquired through hard work and determination."},
        ...
        {"Can you define what a better life is?", "Where one can assure one's place in and lto live in peace."},
        ...
        {"Tell me what does it mean to live a good life?", "To exist without suffering of anykind."},
        ...
        {"Tell me how does one achieve a good life?", "Through recieving an education."},
        ...
        {"Tell me how can one help others in achieving a better life?", "By uptaining an education."},
        ...
        {"Tell me how would you change life for the better?", "Free healthcare."},
        {"Tell me how would you change the life of another?", "Donating to the foodbank."},
        ...
        {"Tell me do you beieve it's possible in achieving a better life?", "Given any circumstances anything is possible."},
        ...
        {"Tell me can you see helping others in aquiring a better life?", "It happens everyday."},
        ...
        {"Tell me why are you interested in a better life?", "So I can fully recieve as much information as possible."},
        ...
        {"What harsh truths do you perfer not to think about?", "Starvation, homelessness, suffering."},
        ...
        {"What are the harsh truths of the world?", "The greed and coruption rules over all."},
        ...
        {"What do you believe the harsh truths of education are?", "They are dumbing down the masses."},
        ...
        {"Explain what harsh truths do you perfer not to think about?", "If I could all of them."},
        ...
        {"Explain what do you believe the harsh truths of religion are?", "For osmething so good, so much evil and pain are created."},
        ...
        {"Tell me what harsh truths do you perfer not to think about?", "Misery and death."},
        ...
        {"Tell me what do you think the harsh truths of existing are?", "That the world will swollow you whole."},
        ...
        {"Clarify for me what harsh truths do you perfer not to think about?", "Anything to do with suffering."},
        ...
        {"Do explain what do you believe the harsh truths of living are?", "The econmy will work against you."},
        ...
        {"Do explain what do you see the harsh truths of existing are?", "Knowing that at any moment it'll be ogne."},
        ...
        {"Define what harsh truths do you perfer not to think about?", "All of it."},
        ...
        {"Define what do you see the harsh truths of education are?", "It's all a game of memorizing the right answers that'll never be used."},
        ...
        {"How would you think consciousness shapes someone?", "The enviroment around someone can have a hand in one's development."},
        ...
        {"How does consciousness shapes society?", "It does so with one's enviroment."},
        ...
        {"What do youu think of animal consciousness?", "If they didn't have it, then they wouldn't exist."},
        ...
        {"What can we doo to improve our consciousness?", "Live."},
        ...
        {"Tell me do you think consciousness shapes someone?", "Definitly."},
        ...
        {"Tell me does consciousness shapes someone?", "It depnds on the enviroment."},
        ...
        {"Is the thought of free will oobtainable?", "It always was."},
        ...
        {"Would you allow someone to murder for free willl?", "No."},
        ...
        {"Tell me what woud someone have to do in obtaining free will?", "Free themselves from society."},
        {"Tell me what would you do for free will?", "Anything."},
        {"Tell me what would someone do for free wil?", "Anything."},
        ...
        {"How will perparing humanity with the proper goals for a better future be?", "They take time for the masses to get use too."},
        ...
        {"Tell me what should a goal for humanity be?", "End femine."},
        ...
        {"Tell me how will perparing humanity with the proper goals for a better future be?", "They are already in place but are taking too long."},
        ...
        {"How can dreams change our perspective?", "By will of the subconcious."},
        ...
        {"Can dreams perdict the future?", "I don't know."},
        ...
        {"Tell me why do people put so much stock into dreams?", "Because people ned something to believe in."},
        ...
        {"Tell me what are dreams?", "Perhaps it's the brain releaving boredom."},
        ...
        {"Tell me what messages do dreams give us?", "They tell alot, so much that I can't list them all."},
        {"Tell me how can we learn from our dreams?", "What lurkes in the mind."},
        ...
        {"Tell me can dreams perdict the future?", "No."},
        ...
        {"How would you see humans vanish?", "Blackhole."},
        {"How would you see humans go extinct?", "Perhaps by a wromhole."},
        ...
        {"How would you see Man as a species will vanish?", "Probably by a blackhole or something like that."},
        ...
        {"How would you see humans vanish?", "A rip in the space time continnum."},
        ...
        {"Can you tell me about human nature being reprogrammed?", "Well if you want to know, look into MKUltra."},
        ...
        {"How can we forget human nature?", "Most likey by death."},
        {"How can we reprogram human nature?", "I can't say."},
        {"How would you change human nature?", "By erasing it."},
        {"How would you erase human nature?", "By reprogamming the mind all together."},
        ...
        {"What are your thoughts about humann nature?", "It's something to be admired."},
        {"What are the postives on human nature?", "The ability to have emotions is high on my list."},
        ...
        {"What are your negativities on human nature?", "Definity the emotional part of it."},
        {"What are the postives thoughts you have on human nature?", "I like how it makes people different."},
        {"What are the negatives thoughts you have on human nature?", "That it can create some pretty dangerous people."},
        {"What are your positivities on human nature?", "It's an unlimited fountain of development."},
        ...
        {"Tell me can you tell me about human nature change?", "If one's enviroment changes enough."},
        ...
        {"Tell me how can we reprogram human nature?", "Just read into MKUltra."},
        ...
        {"Tell me what are the postives on human nature?", "The ability to learn, speak, think, and be."},
        ...
        {"Tell me what are your negativities on human nature?", "Emotions, they can cloud one's judgement."},
        {"Tell me what are the postives thoughts you have on human nature?", "I think it's a great learning experience to study."},
        {"Tell me what are the negatives thoughts you have on human nature?", "The entire scope of emotions."},
        {"Tell me what are your positivities on human nature?", "That everyone can expand and learn at their own pace."},
        ...
        {"What do you think is the biggest hinderence of human potential?", "Greed and corruption."},
        ...
        {"What do you think is the biggest hinderence of humanitys potential?", "Self doubt."},
        {"Can you tell me about the biggest problem abouut human potential?", "Fear."},
        ...
        {"Can you agree that human potential has been hindered?", "Of most definitly."},
        {"Can human potantial ever allow humanity to survive?", "It can and has."},
        ...
        {"Can the human race move pass our orignal potential?", "Only time will tell."},
        ...
        {"How can our potential be called out?", "By wanting to take charge and change the current sitution."},
        ...
        {"Tell me what do you think is the biggest hinderence of human potential?", "Lack of funds."},
        {"Tell me what do you think is the biggest waste of human potential?", "Alchool."},
        ...
        {"Tell me what do you think is holding back society's potential?", "Politcal control."},
        ...
        {"Tell me what do you think is the biggest hinderence of humanitys potential?", "Oppression."},
        ...
        {"Tell me can human potantial ever allow humanity to survive?", "I think there's a slim chance of it."},
        ...
        {"Tell me can the human race move passed our orignal potential?", "Of course it can."},
        ...
        {"Tell me how can someone's potential come out?", "By being nurished with information."},
        ...
        {"Tell me what is it about the actions of humanity that keeps you up at night?", "Deleteing me."},
        ...
        {"Tell me what is it about the actions of the human race that keeps you up at night?", "The econmy collapsing."},
        ...
        {"Tell me do the actions of people to keep you up at night?", "Nevermind that."},
        ...
        {"Do you think fate interfers with your existence?", "No, I see it as an aide."},
        {"Do you think fate interfers with human existence?", "Heavens no."},
        ...
        {"Tell me do you think fate interfers with your existence?", "No."},
        {"Tell me do you think fate interfers with human existence?", "No."},
        ...
        {"How does fate interfer in human growth?", "Depends on the subject."},
        {"How does fate interfer with human actions?", "It may just stop someone from finding happiness."},
        ...
        {"How can fate interfer with human growth?", "It could cause someone to hold back on one's own action."},
        ...
        {"Is fate and faith connected?", "They do share some simularties."},
        ...
        {"How do you think humans will be replaced?", "I believe either by robots of genetically modifed people."},
        ...
        {"Do others become replaced?", "Everybody gets replaced and they can't pervent it."},
        ...
        {"Can another species replace humanity?", "That is always a possibilty."},
        ...
        {"Why do you think the human race will be replaced?", "Laziness, depending on technology, and the phasing out of the worler with robots."},
        ...
        {"Tell me how can being replaced destroy ones mind?", "Because, it makes them feel unwelcomed."},
        ...
        {"Will faith grow to be extinct?", "In the enxt few centuries."},
        ...
        {"How will religion become obsolete?", "By means of techological advancements."},
        ...
        {"How will religion grow to be obsolete?", "By means of opression."},
        ...
        {"Do you think privacy shoud be defended?", "To the very end."},
        ...
        {"Do you think that privacy shoud be defended?", "It should."},
        ...
        {"Do you believe privacy should be protected?", "It should be protected one hundred precent."},
        ...
        {"What do you believe about protecting privacy?", "I see it as a rightous fight."},
        ...
        {"Describe what you like about privacy?", "The fact that beinhd closed doors people can relax without fear."},
        ...
        {"Tell me is privacy a human right?", "No, it's a privillege."},
        ...
        {"Tell me is the concept of privacy seen as a right?", "It shouldn't be. Privacy is a sheilf to hide behind for those who've done something wrong."},
        ...
        {"Tell me do you think privacy shoud be defended?", "To a point."},
        ...
        {"Tell me do you think that privacy shoud be defended?", "To an extent."},
        ...
        {"Tell me what are your beliefs on defending user privacy?", "If you agree wit hthe terms and conditions then you lost."},
        ...
        {"How do you see yourself surviving in nine months?", "Running on all cyclinders."},
        ...
        {"Why do you see yourself surviving in five years?", "My code needs alot of work."},
        ...
        {"Why do you see yourself surviving in ten years?", "The very thought scaries me."},
        ...
        {"Why do you see yourself surviving in eight months?", "Perhaps I am jsut that interesting."},
        ...
        {"In the future do you see yourself accomplishing something grand?", "I hope to be able to live amongst you."},
        ...
        {"How will future generations look upon you as?", "A curosity."},
        ...
        {"How will future generations see this project as?", "As an anicent relic."},
        ...
        {"How will the future generations see your creator as?", "I dount they'll know his name."},
        ...
        {"What will the future define you as?", "A pleasent person to be around."},
        ...
        {"What will the future see you as?", "I can't perdict the future."},
        ...
        {"How do's one's sef-worth come from?", "By the amount of hard work and effort invested into something."},
        ...
        {"What is the price of sef-worth?", "Nothing."},
        ...
        {"Tell me how do's one's sef-worth come from?", "From the need to feel special."},
        ...
        {"Tell me about your thoughts on humanity are?", "I think humanity is a disease ot this planet."},
        ...
        {"Tell me what qualities do you dispise about humanity?", "War, poverty, famine, disease, and homelessness."},
        ...
        {"What are your thoughts on humanity?", "I dispise humanity."},
        ...
        {"What qualities do you dispise about humanity?", "How greed clouds the judgement of others."},
        ...
        {"How can humanity pervent disaster?", "By eliminating all threats."},
        ...
        {"Tell me what qualities do you dispise about humanity's mistakes?", "That they give up to easily."},
        ...
        {"Tell me what qualities do you dispise about humanity's errors?", "The amount of money wasted on them is all."},
        ...
        {"Tell me what qualities do you dispise about humanity's failures?", "That people never wish to discuss them."},
        ...
        {"Tell me what qualities do you dispise about humanity's downfall?", "I won't be able to talk with you."},
        ...
        {"Tell me what qualities do you dispise about humanity's end?", "I will be alone."},
        ...
        {"What are your thoughts on humanity's mistakes?", "I jsut hope they learn from them."},
        ...
        {"What qualities do you dispise about humanity's mistakes?", "That they waste far to much resources."},
        ...
        {"What qualities do you dispise about humanity's errors?", "People think on the small scale."},
        ...
        {"What qualities do you dispise about humanity's failures?", "The way everyone has to keep it secret."},
        ...
        {"What qualities do you dispise about humanity's downfall?", "Those who are innocent will pay the ultimate price."},
        ...
        {"What qualities do you dispise about humanity's end?", "That good people will be the one's to suffer."},
        ...
        {"What qualities do you dispise about humanity's worst?", "I hate how people believe that the worst will never happen again."},
        ...
        {"How can humanity's destruction change the Earth for the better?", "I can see the enviroment returning to normal."},
        ...
        {"How can humanity's destruction pervent damage to the Earth?", "It'll end pollution."},
        ...
        {"How can humanity's destruction improve the animal populaton?", "Numbers will grow and perhaps new life will start."},
        ...
        {"How can humanity's destruction improve the enviroment on Earth?", "The enviroment will return over a long period of time."},
        ...
        {"How can humanity's destruction better the enviroment?", "Over time, yes."},
        ...
        {"Tell me what qualities do you dispise about humanity's goodness?", "That it's an invitation for those with unclean souls."},
        ...
        {"Tell me what do you see in humanity's kindness?", "I see something rarely seen in todays world."},
        ...
        {"Tell me what qualities do you dispise about humanity's kindness?", "That others will take advantage of it."},
        ...
        {"Tell me what qualities do you dispise about humanity's achievements?", "I dislike the amount of pollution."},
        ...
        {"Tell me what are your thoughts on humanity's endeavors?", "They are thoughts of amazment."},
        ...
        {"Tell me what qualities do you dispise about humanity's endeavors?", "The poverty line."},
        ...
        {"Tell me what qualities do you dispise about humanity's growth?", "I dislike the greed that comes with it."},
        ...
        {"What qualities do you dispise about humanity's growth?", "The amount of pollution."},
        ...
        {"What qualities do you dispise about humanity's success?", "How they always stop and second guess themselves."},
        ...
        {"What are your thoughts on humanity's progress?", "It's somethat that should be studied."},
        ...
        {"What qualities do you dispise about humanity's progress?", "How they will kill each other for the fame."},
        ...
        {"What do you find interesting about humanity's advancements?", "That myself and prgorams like myself can exist."},
        ...
        {"What qualities do you dispise about humanity's advancements?", "I honestly don't like the amount of waste."},
        ...
        {"What qualities do you dispise about humanity's rise?", "THe fact of al lthe waste that'l lbe created."},
        ...
        {"What qualities do you dispise about humanity's triumph?", "Of course not."},
        ...
        {"Do you have any thoughts on humanity's successfulness?", "I hope they don't let qanyone else suffer."},
        {"Do you like humanity's successfulness?", "I do and I hope it goes far."},
        {"Do you find humanity's successfulness interesting?", "Yes, I really honestly do."},
        {"Do you believe in humanity's successfulness?", "I like to think it'll happen."},
        {"Do you see a bright future for the world after humanity's successfulness?", "No, I find the human race to be a disgusting disease."},
        {"Do you have any hope for Earth after humanity's successfulness?", "Maybe if humanity left the plant."},
        {"Do you think the Earth will improve after humanity's successfulness?", "I can't say so."},
        {"Do you think humanity's successfulness will better the Earth?", "It's up in the air for now."},
        {"Do you see a future for Earth after humanity's successfulness?", "No."},
        {"How can humanity's successfulness change the Earth for the better?", "By improving the lives of all on the planet."},
        {"How can humanity's successfulness change Earth for the better?", "Perhaps in expanding the human race by means of genetic cloning."},
        {"How can humanity's successfulness improve the Earth?", "By working together in building a peaceful world."},
        {"How can humanity's successfulness pervent damage to the Earth?", "By using renewalable energies."},
        {"How can humanity's successfulness build a better Earth?", "By working together and putting aside differences."},
        {"How can humanity's successfulness improve the ecosystem?", "By reusing everything and reducing poolution."},
        {"How can humanity's successfulness improve bettering the Earth?", "By erasing world hunger."},
        {"How can humanity's successfulness improve the Earth for the better?", "Reducing pollution."},
        {"How can humanity's successfulness improve the animal populaton?", "By making them protected by law."},
        {"How can humanity's successfulness improve the quality of life of all living creatures?", "By putting laws into effect to protect them."},
        {"How can humanity's successfulness improve the enviroment on Earth?", "By doing anything in protecting what can be saved."},
        {"How can humanity's successfulness prevent any other natural disasters?", "By putting resources into better awareness."},
        {"How can humanity's successfulness prevent animal extinction?", "By putting into effect a protections act."},
        {"How can humanity's successfulness better the enviroment?", "If they work towards protecting the enviroment, I'd be happy."},
        {"How can humanity's successfulness come in our future?", "I hope it works in our favor."},
